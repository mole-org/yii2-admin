...
.markdown-body pre,
.markdown-body samp {
  font-family: 'Courier', Consolas, "Liberation Mono", Menlo, Courier, monospace;
  font-size: 12px;
}
...
</style><title><?= $title ?></title></head><body><article class="markdown-body"><?= $md ?></article></body></html>
